...
const Sidebar = () => {
  ...
  return (
    <div
      className={`top-0 left-0 z-50 bg-gray-900 h-[100vh] ${
        open ? "fixed  lg:w-64 w-full" : "hidden"
      }`}
    >
      <div className="relative">
        <div className=" pt-5 w-full bg-gray-900">
          <div className="flex items-center justify-between flex-shrink-0 px-4">
            <a
              href="https://kalbelajobs.com"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img className="lg:w-64 w-48 h-auto  " src={logo} alt="" />
            </a>
            <X
                  ...
                  <div div key={index}>
                    ...
                    >
                      <NavLink
                        to={item.link}
                        className={({ isActive }) =>
                          `border border-white border-opacity-40 p-2 transition-all duration-200  hover:text-blue-700 rounded-lg hover:bg-gray-200 cursor-pointer group ${
                            isActive
                              ? "  bg-gray-200  text-blue-500 text-opacity-70"
                      ...
                      <h3 className="font-semibold text-opacity-70 text-gray-300">
                        {item.title}
                      </h3>
                    </NavLink>
                    <hr className="border-gray-700" />
