...
const Not_Found = () => {
      return (
            <>
                  ...
                  <div
                        className={`h-screen w-screen dark:bg-light-dark text-white bg-gray-100 flex items-center`}
                  >
                        <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
                              <div className="max-w-md">
                                    <div
                                          className='dark:text-gray-600 text-white text-5xl font-dark font-bold' >
                                          404
                                    </div>
                                    <p
                                          className="dark:text-gray-600 text-white text-2xl md:text-3xl font-light leading-normal"
                                    >
                                          Sorry we couldn't find this page.{' '}
                                    </p>
                                    <p
                                          className='text-gray-600 dark:text-gray-600 mb-8'                                    >
