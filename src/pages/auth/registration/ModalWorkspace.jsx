...
export default function ModalWorkspace({ controlWidth }) {
      ...
      console.log(`${base_url}/config/industries?token=${user._id}`);
      ...
      return (
            <div className=" bg-white  ">
                  <div className=" px-4 sm:px-6 bg-white ">
                        ...
                        <hr className="my-6" />
                        <div
                        // className={`grid grid-cols-1 mt-12 sm:mt-16 lg:mt-20 ${controlWidth ? "" : "lg:grid-cols-6"
                                                ...
                                                <div className="mt-2">
                                                      {controlWidth ? (
                                                            <input
                                                                  ...
                                                                  className="block w-full px-5 py-2 text-base font-normal text-black placeholder-gray-500 bg-white border border-gray-800 rounded-md focus:border-white focus:ring-white focus:ring-1"
                                                            />
                                                      ) : (
                                                            <input
                                                                  type="text"
                                          ...
                                          <div>
                                                ...
                                                <div className="mt-2">
                                                      <select
                                                            ...
                                                            required
                                                            id="company_size"
                                                            className="block w-full py-2.5 pl-5 pr-10 text-base font-normal text-black placeholder-gray-500 bg-white border border-gray-800 rounded-md focus:border-white focus:ring-white focus:ring-1"
                                                      >
                                          ...
                                          <div className="sm:col-span-1">
                                                ...
                                                <div className="mt-2">
                                                      <input
                                                            ...
                                                            className="block w-full py-2 pl-5 pr-10 text-base font-normal text-black placeholder-gray-500 bg-white border border-gray-800 rounded-md focus:border-white focus:ring-white focus:ring-1"
                                                      />
                                                </div>
                                          </div>
                                          <div className="sm:col-span-2">
                                                ...
                                                <div className="mt-2 ">
                                                      <Select
                                                            ...
                                                            name="industry"
                                                            id="industry"
                                                            className=" h-10 bg-white !border-opacity-20 block  w-full"
