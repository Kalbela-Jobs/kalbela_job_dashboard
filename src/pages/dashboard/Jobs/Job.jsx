...
const Job = () => {
  ...
  console.log("hello checked5555", jobs);
  return (
    <div>
      <div className="py-4 bg-white  ">
        <div className="px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4 mt-4">
            ...
            >
              <Select.Option selected value="false">
                Active
              </Select.Option>
                    ...
                    {jobs?.jobs?.map((job, index) => (
                      <tr key={job._id} className="bg-gray-50">
                        ...
                        <td className="hidden px-4 py-4 text-sm font-medium text-gray-900 lg:table-cell whitespace-nowrap">
                          <div className="flex items-center">{job.vacancy}</div>
                        </td>
      ...
      {modal && (
        <Modal_Component
          ...
          set_modal={set_modal}
          JSX={
            <Edit_jobs refetch={refetch} set_modal={set_modal} data={modal} />
          }
        />
      )}
  ...
  const menu = (
    <Menu>
      ...
      <Menu.Item
        ...
        onClick={() =>
          updateJobs(
            { feature_status: !job.feature_status },
            `?job_id=${job._id}`
          )
        }
        icon={
          <StarOutlined
            style={{ color: job.feature_status ? "yellow" : "gray" }}
          />
        }
      >
      ...
      <Menu.Item
        key="status"
        onClick={() =>
          updateJobs({ status: !job.status }, `?job_id=${job._id}`)
        }
        icon={
          <PoweroffOutlined style={{ color: job.status ? "green" : "gray" }} />
        }
      >
