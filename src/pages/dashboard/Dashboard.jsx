...
const Dashboard = () => {
      ...
      const [recentCustomers] = useState([
            {
                  ...
                  spent: 11234,
                  location: 'Austin',
                  avatar: 'https://landingfoliocom.imgix.net/store/collection/clarity-dashboard/images/previews/dashboards/1/avatar-male.png',
            },
            {
                  id: 2,
                  name: 'Devon Lane',
                  ...
                  spent: 11159,
                  location: 'New York',
                  avatar: 'https://landingfoliocom.imgix.net/store/collection/clarity-dashboard/images/previews/dashboards/1/avatar-male-2.png',
            },
      ...
      return (
            <div className="flex flex-col min-h-screen" onClick={() => setOpenDropdown(null)}>
                  <Header />
                                                            ...
                                                            <div className="bg-white border border-gray-200 rounded-xl">
                                                                  <div className="px-5 py-4">
                                                                        ...
                                                                        <div className="flex items-center justify-between mt-3">
                                                                              <p className="text-xl font-bold text-gray-900">${salesData.todaySale}</p>
                            ...
                            >
                                                            ...
                                                            <div className="bg-white border border-gray-200 rounded-xl">
                                                                  <div className="px-5 py-4">
                                                                        ...
                                                                        <div className="flex items-center justify-between mt-3">
                                                                              <p className="text-xl font-bold text-gray-900">${salesData.totalSales}</p>
                                                            ...
                                                            <div className="bg-white border border-gray-200 rounded-xl">
                                                                  <div className="px-5 py-4">
                                                                        ...
                                                                        <div className="flex items-center justify-between mt-3">
                                                                              <p className="text-xl font-bold text-gray-900">{salesData.totalCustomers}</p>
                                                                              <span className="inline-flex items-center text-sm font-semibold text-green-500">
                                                                                    + 36%
                                                                                    <svg
                                                                                          xmlns="http://www.w3.org/2000/svg"
                                                      ...
                                                      <div className="overflow-hidden bg-white border border-gray-200 rounded-xl">
                                                            ...
                                                            <div className="divide-y divide-gray-200">
                                                                  {transactions.map((transaction) => (
                                                                        <div key={transaction.id} className="grid grid-cols-3 py-4 gap-y-4 lg:gap-0 lg:grid-cols-6">
                                                                              <div className="col-span-2 px-4 lg:py-4 sm:px-6 lg:col-span-1">
                                                                                    <span className={`text-xs font-medium rounded-full inline-flex items-center px-2.5 py-1 ${transaction.status === 'Completed' ? 'text-green-900 bg-green-100' :
                                                                                          transaction.status === 'Pending' ? 'text-yellow-900 bg-yellow-100' :
                                                                                                'text-red-900 bg-red-100'
                                                                                          }`}>
                                                                                          <svg
                                                                                                className={`-ml-1 mr-1.5 h-2.5 w-2.5 ${transaction.status === 'Completed' ? 'text-green-500' :
                                                                              ...
                                                                              <div className="px-4 lg:py-4 sm:px-6 lg:col-span-2">
                                                                                    <p className="text-sm font-bold text-gray-900">
                                                                                          {transaction.cardType} card **** {transaction.cardNumber}
                                                                                    </p>
                                                                                    <p className="mt-1 text-sm font-medium text-gray-500">
                                                                                          Card payment
                                                                                    </p>
                                                            ...
                                                            <div className="px-4 py-5 sm:p-6">
                                                                  ...
                                                                  <div className="mt-8 space-y-6">
                                                                        {recentCustomers.map((customer) => (
                                                                              <div key={customer.id} className="flex items-center justify-between space-x-5">
