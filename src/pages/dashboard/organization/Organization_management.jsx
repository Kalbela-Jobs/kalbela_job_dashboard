...
const OrganizationManagement = () => {
      ...
      const handleDelete = (staff_id, workspace_id) => {
            Modal.confirm({
                  title: "Are you sure?",
                  content: "Do you really want to delete this staff member? This action cannot be undone.",
                  okText: "Yes, Delete",
                  okType: "danger",
                  cancelText: "Cancel",
                                                                  ...
                                                                  <tbody>
                                                                        {selectedOrg.staff.map((staff) => (
                                                                              <tr key={staff._id} className="text-start">
                                                                                    <td className="border capitalize border-gray-300 px-4 py-2">{staff.name}</td>
                                                                                    <td className="border capitalize border-gray-300 px-4 py-2">{staff.role}</td>
                                                                                    <td className="border border-gray-300 text-center px-4 py-2">
                                                                                          <button
                                                                                                onClick={() => handleDelete(staff._id, selectedOrg._id)}
