                              ...
                              <Modal_Component
                                    ...
                                    JSX={
                                          <div className="p-4 space-y-4">
                                                ...
                                                {/* Organization Info */}
                                                <p><strong>Name:</strong> {selectedOrg.company_name}</p>
                                                <p><strong>Website:</strong>
                                                      <a href={selectedOrg.website} target="_blank" rel="noopener noreferrer" className="text-blue-600">
                                                            {selectedOrg.website}
                                                      </a>
                                                </p>
                                                <p><strong>Company Size:</strong> {selectedOrg.company_size}</p>
                                                <p><strong>Industry:</strong> {selectedOrg.industry.charAt(0).toUpperCase() + selectedOrg.industry.slice(1)}</p>
                                                <p><strong>Address:</strong> {selectedOrg.address}</p>
                                                <p><strong>Priority:</strong> {selectedOrg.priority.charAt(0).toUpperCase() + selectedOrg.priority.slice(1)}</p>
                                                <p><strong>Featured:</strong>   <Switch
                                                      checked={selectedOrg.feature}
                                                      onChange={() => updateFeature(selectedOrg)}
                                                      checkedChildren="Featured"
                                                      unCheckedChildren="Feature"
                                                /></p>
                                                <p><strong>Status:</strong> {selectedOrg.status ? "Active" : "Inactive"}</p>
                                                <p><strong>Created At:</strong> {new Date(selectedOrg.created_at).toLocaleString()}</p>
                                                {/* Trade License (if available) */}
                                                {selectedOrg.trade_license && (
                                                      <div>
                                                            <p><strong>Trade License:</strong></p>
                                                            <a href={selectedOrg.trade_license} target="_blank" rel="noopener noreferrer" download>
                                                                  <img
