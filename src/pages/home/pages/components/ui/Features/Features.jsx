...
const Features = () => {
      ...
      // this is for kalbela jobs features
      ...
      const featuresList = [
            {
                  ...
                  desc: "This feature uses AI to match candidates with the right job based on their skills and experience."
            },
            {
                  icon:
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                  ...
                  title: "Limitless Job Posting",
                  desc: "Post as many jobs as you want without any restrictions or additional charges."
            },
            {
                  icon:
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                  ...
                  desc: "Send automated emails to candidates to keep them updated on the status of their applications."
            },
            {
                  icon:
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                  ...
                  desc: "Create and send assessments to candidates to evaluate their skills and knowledge."
            },
            {
                  icon:
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                  ...
                  desc: "Schedule interviews with candidates and send them notifications about the date and time."
            },
            {
                  icon:
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
